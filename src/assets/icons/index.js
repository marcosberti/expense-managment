...
const ExpensesIcon = ({fill = '#fff', size = 24}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill={fill}
...
const IncomeIcon = ({fill = '#fff', size = 24}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill={fill}
...
const MoneyBalanceIcon = ({fill = '#fff', size = 24}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill={fill}
...
const NavigationBackIcon = ({fill = '#fff', size = 24}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill={fill}
...
const NavigationNextIcon = ({fill = '#fff', size = 24}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill={fill}
